...
public class bookshop {
	...
	final String global_sshUser = "e9214294";
	final String global_sshPwd = "LIshiwen123_";
...
//			}
//	}
	public String orderSearch(String str){  //main function 1:
		System.out.println("Please input the Student ID to search order info:");
//		String line = in.nextLine();
		String  orderStr = "";
		String line = str;
...
//		System.out.println(line);
		...
		if (line.equals("admin")) {
			...
			boolean checkNo = checkSnum(snum);
			if (checkNo == true)
				orderStr = printOrderBySnum(snum);
